...
export function SiteFooter() {
  return <footer className="site-footer"><div className="footer-shell">
    ...
    <div className="footer-meta"><span>© 2026 AssetForge. All rights reserved. · v0.6 Beta</span><div><a href="https://www.instagram.com/assetforge.ai/" target="_blank" rel="noreferrer" aria-label="AssetForge on Instagram"><Instagram size={15} /></a><button type="button" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>Top <ChevronUp size={14} /></button></div></div>
