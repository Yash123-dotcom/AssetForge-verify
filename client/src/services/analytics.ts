...
type AnalyticsEvent = 'asset_url_submitted' | 'asset_analysis_success' | 'asset_analysis_partial' | 'asset_analysis_failed' | 'metadata_corrected' | 'verification_started' | 'report_created' | 'beta_started' | 'verify_abandoned' | 'report_viewed' | 'top_issue_seen' | 'feedback_started' | 'feedback_completed' | 'usefulness_submitted' | 'assetforge_cta_clicked' | 'retry_after_error' | 'report_shared' | 'deep_scan_started' | 'deep_scan_completed' | 'deep_scan_failed' | 'deep_scan_timed_out' | 'deep_scan_report_viewed';
