...
export function VerifyPage() {
  ...
  return <main className="verify-page shell">
    <div className="page-heading"><div><p className="eyebrow">COMPATIBILITY CHECK / 001</p><h1>Check this asset<br /><span>before importing.</span></h1></div><div className="page-heading-copy"><BetaBadge /><p>Compare a Unity asset with your project setup. Review the details we found, then generate a clear report of the main compatibility risks.</p><button className="try-example" type="button" onClick={tryExample}>Load example setup</button></div></div>
