...
export function HomePage() {
  return <main className="editorial-home">
    <section className="brand-hero shell">
      ...
      <div className="hero-beta"><BetaBadge /><span>AssetForge Verify is still learning from real-world Unity setups.</span></div><h1>Know before<br />you <span>import.</span></h1>
